...
/**
 * Prompt user authorization, get and store new token, then execute the
 * callback.
...
/**
 * Create an OAuth2 client with the provided credentials, then execute the
 * callback.
...
/**
 * Class providing mail delivery routines with Gmail.
 */
